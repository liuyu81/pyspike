...
py_extension_t::get_instructions() {
    PYBIND11_OVERRIDE_PURE(std::vector<insn_desc_t>, extension_t, get_instructions);
}

std::vector<disasm_insn_t*>
py_extension_t::get_disasms() {
    PYBIND11_OVERRIDE_PURE(std::vector<disasm_insn_t*>, extension_t, get_disasms);
}
...
void
py_extension_t::reset() {
    PYBIND11_OVERRIDE(void, extension_t, reset);
}

void
py_extension_t::set_debug(bool value) {
    PYBIND11_OVERRIDE(void, extension_t, set_debug, value);
}

void
py_extension_t::set_processor(processor_t* _p) {
    PYBIND11_OVERRIDE(void, extension_t, set_processor, _p);
}

reg_t
py_rocc_t::custom0(rocc_insn_t insn, reg_t xs1, reg_t xs2) {
    PYBIND11_OVERRIDE(reg_t, rocc_t, custom0, insn, xs1, xs2);
}

reg_t
py_rocc_t::custom1(rocc_insn_t insn, reg_t xs1, reg_t xs2) {
    PYBIND11_OVERRIDE(reg_t, rocc_t, custom1, insn, xs1, xs2);
}

reg_t
py_rocc_t::custom2(rocc_insn_t insn, reg_t xs1, reg_t xs2) {
    PYBIND11_OVERRIDE(reg_t, rocc_t, custom2, insn, xs1, xs2);
}

reg_t
py_rocc_t::custom3(rocc_insn_t insn, reg_t xs1, reg_t xs2) {
...
void
py_register_extension(const std::string& name, py::function py_ctor) {
