...
PYBIND11_MODULE(_riscv, m) {
  ...
  // riscv.cfg
  {
    ...
    py::class_<managed_cfg_t>(mod_cfg, "cfg_t")
        .def(py::init())
        .def(py::init(&managed_cfg_t::create),
             py::kw_only(),
             py::arg("isa") = py::none(),
             py::arg("priv") = py::none(),
  ...
  // riscv.disasm
  {
    ...
    py::class_<disasm_insn_t>(mod_disasm, "disasm_insn_t")
        .def(py::init(&py_disasm_insn_t_create),
             py::arg("name"), py::arg("match"), py::arg("mask"))
    ...
    mod_disasm.attr("xpr_name") = std::vector<std::string>(xpr_name, xpr_name + NXPR);
    mod_disasm.attr("fpr_name") = std::vector<std::string>(fpr_name, fpr_name + NFPR);
    mod_disasm.attr("vr_name") = std::vector<std::string>(vr_name, vr_name + NVPR);
  }
  ...
  // riscv.extension
  {
    ...
    py::class_<rocc_insn_t>(mod_extension, "rocc_insn_t")
      .def_property_readonly("opcode", [](const rocc_insn_t& self) -> unsigned {
        return self.opcode;
      })
      .def_property_readonly("rd", [](const rocc_insn_t& self) -> unsigned {
        return self.rd;
      })
      .def_property_readonly("xs2", [](const rocc_insn_t& self) -> unsigned {
        return self.xs2;
      })
      .def_property_readonly("xs1", [](const rocc_insn_t& self) -> unsigned {
        return self.xs1;
      })
      .def_property_readonly("xd", [](const rocc_insn_t& self) -> unsigned {
        return self.xd;
      })
      .def_property_readonly("rs1", [](const rocc_insn_t& self) -> unsigned {
        return self.rs1;
      })
      .def_property_readonly("rs2", [](const rocc_insn_t& self) -> unsigned {
        return self.rs2;
      })
      .def_property_readonly("funct", [](const rocc_insn_t& self) -> unsigned {
        return self.funct;
      });
    ...
    py::class_<rocc_t, py_rocc_t, extension_t>(mod_extension, "rocc_t")
      .def(py::init())
      // rocc_t members
      .def("custom0", &rocc_t::custom0, py::arg("insn"), py::arg("xs1"), py::arg("xs2"))
      .def("custom1", &rocc_t::custom1, py::arg("insn"), py::arg("xs1"), py::arg("xs2"))
      .def("custom2", &rocc_t::custom2, py::arg("insn"), py::arg("xs1"), py::arg("xs2"))
      .def("custom3", &rocc_t::custom3, py::arg("insn"), py::arg("xs1"), py::arg("xs2"))
      .def("get_instructions", &rocc_t::get_instructions)
      .def("get_disasms", &rocc_t::get_disasms)
      .def_property_readonly("name", &rocc_t::name);

    mod_extension
      .def("find_extension", &find_extension)
      .def("register_extension", &py_register_extension,
           py::arg("name"), py::arg("f"), py::return_value_policy::reference);
  }
  ...
  // riscv.processor
  {
    ...
    mod_processor.attr("insn_func_ctype").doc() = "Prototype of C++ function pointer to insn_func_t";

    mod_processor.attr("insn_func_py2ct") = symb["insn_func_py2ct"];
    mod_processor.attr("insn_func_py2ct").doc() = "Decorator for Python -> C++ adaption of insn_func_t";

    mod_processor.attr("insn_func_ct2py") = symb["insn_func_ct2py"];
    mod_processor.attr("insn_func_ct2py").doc() = "Decorator for C++ -> Python adaption of insn_func_t";

    mod_processor.attr("illegal_instruction") = py::cpp_function([](processor_t * p, insn_t insn, reg_t pc) -> reg_t {
  ...
  // riscv.sim
  {
    ...
    py::class_<sim_t, py_sim_t, htif_t, simif_t>(mod_sim, "sim_t",
        ...
        .def(py::init(&py_sim_t::create), py::kw_only(), 
             py::arg("cfg"), py::arg("halted"),
             py::arg("plugin_device_factories"), py::arg("args"),
             py::arg("dm_config"))
